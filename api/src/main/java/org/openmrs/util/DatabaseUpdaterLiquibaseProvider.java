...
/**
 * Provides a wrapper for org.openmrs.util.DatabaseUpdater#getLiquibase(String) that can be injected into helper 
 * methods provided by the org.openmrs,liquibase.ChangeLogDetective class. 
 */
